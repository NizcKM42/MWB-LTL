...
-- Stat Info
MWBLTL.LANGUAGE["StatInfo_Shake"] = "Стабильн. прицелив."
MWBLTL.LANGUAGE["StatInfo_AimSway"] = "Дрожание прицела"
MWBLTL.LANGUAGE["StatInfo_MovementMultiplier"] = "Стабильн. оруж. при перемещ."
MWBLTL.LANGUAGE["StatInfo_HeadshotMultiplier"] = "Урон в голову"
MWBLTL.LANGUAGE["StatInfo_ProjectileSpeed"] = "Скорость пуль"
MWBLTL.LANGUAGE["StatInfo_ProjectileGravity"] = "Стабильн. пуль"
MWBLTL.LANGUAGE["StatInfo_ClipSize"] = "Размер магазина"
MWBLTL.LANGUAGE["StatInfo_RPM"] = "Выст. в минуту"
MWBLTL.LANGUAGE["StatInfo_AimSpeed"] = "Скор. прицелив."
MWBLTL.LANGUAGE["StatInfo_SprintSpeed"] = "Задерж. стр. после бега"
MWBLTL.LANGUAGE["StatInfo_AimLength"] = "Время прицелив."
MWBLTL.LANGUAGE["StatInfo_RechamberSpeed"] = "Скор. перезарядки"
MWBLTL.LANGUAGE["StatInfo_AimAccuracy"] = "Точность в прицелив."
MWBLTL.LANGUAGE["StatInfo_ConeIncrease"] = "Разброс при стрельбе"
MWBLTL.LANGUAGE["StatInfo_Accuracy"] = "Точность"
MWBLTL.LANGUAGE["StatInfo_ReloadSpeed"] = "Скор. перезарядки"
MWBLTL.LANGUAGE["StatInfo_SwitchSpeed"] = "Скор. смены оружия"
MWBLTL.LANGUAGE["StatInfo_DrawLength"] = "Время достав. оружия"
MWBLTL.LANGUAGE["StatInfo_HolsterLength"] = "Время убир. оружия"
...
MWBLTL.LANGUAGE["StatInfo_EffectiveRange"] = "Эффект. дистанция"
MWBLTL.LANGUAGE["StatInfo_MaxRange"] = "Макс. дистанция"
MWBLTL.LANGUAGE["StatInfo_PenetrationThickness"] = "Проникающая сила"
MWBLTL.LANGUAGE["StatInfo_HorizontalRecoil"] = "Гориз. отдача"
MWBLTL.LANGUAGE["StatInfo_Recoil"] = "Отдача"
MWBLTL.LANGUAGE["StatInfo_VerticalRecoil"] = "Вертик. отдача"
...
MWBLTL.LANGUAGE["StatInfo_SprintLength"] = "Задерж. стр. после бега"
...
MWBLTL.LANGUAGE["SpawnMenu_VM_Text2"] = "Угол обз. - прицел"
...
MWBLTL.LANGUAGE["SpawnMenu_SC_Text10"] = "Огранич. по оформлению"
